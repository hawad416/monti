...
with st.chat_message("assistant"):
        intro = "hey! i am monti 🧸, your friend for helping you create the most magical stories and improve your reading comprehension , writing skills, crticial thinking & your imagination. let's get started!"
        st.markdown(intro)
